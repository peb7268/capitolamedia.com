	...
	function of_options()
	{
		...
		( 
			"enabled" => array (
				...
				"quotes_middle_block" => "Quotes (Middle)",
...
$of_options[] = array( "desc" => __('Enter a URL for your logo to link to. <br />(ie; http://guuthemes.com)', 'nash'),
...
$of_options[] = array( "name" => __('Quotes (Middle) Background Image', 'nash'),
					"desc" => __('Upload a background image to use in your (middle) quotes section.', 'nash'),
					"id" => "upload_quotes_middle_background",
					"std" => "",
					"type" => "media");
