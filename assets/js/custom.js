...
jQuery(document).ready(function ($) {	
	...
	if($('.home').length > 0){
		if(Modernizr.mq('only all and (max-width: 768px)')){
			...
			window.videoPlayer = BV.getPlayer();	   		
			
			//http://capitolamedia.com/wp-content/themes/nash/assets/videos/skater_test.mp4
			//http://capitolamedia.com/wp-content/themes/nash/assets/videos/poster_frame.jpg
			
			BV.show('http://capitolamedia.com/wp-content/uploads/2013/12/camera1.jpg');
			
			$('#BV').on('click', function(e) {
	            e.preventDefault();
	            if($(this).find('.vjs-playing').length > 0){
		        	videoPlayer.pause();
		        } else {
			       	if($(this).find('.vjs-has-started').length > 0) return videoPlayer.play();
		            BV.show('http://capitolamedia.com/wp-content/themes/nash/assets/videos/skater_test.mp4', {
		         	  'controls': true,
		         	  'ambient' : true
		            });
	            }
